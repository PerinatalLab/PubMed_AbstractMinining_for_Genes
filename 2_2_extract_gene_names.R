...
# extract PubMed genes that are related to PREGNANCY/Obstetrics (based on abstract mining)
# (not to confuse with script that searchers women_tissue-related genes)
...
#rm(list=ls())
#setwd("~/Biostuff/MOBA_GESTAGE_GWAS/PREGNANCY_GENES/PubMed_2015Jul_OBSTETRICS/")
...
save(list=c("gene_lists"),file=paste(result_dir,"PubMed_extracted_genes_OBSTETRICSandCONTROL.RData",sep=""))
